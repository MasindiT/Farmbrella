<%@ Page Title="" Language="C#" MasterPageFile="~/FarmMaster.Master" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="FarmbrellaSite.contact" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Email:</span> <a href="mailto:farmbrellaza@gmail.com">farmbrellaza@gmail.com</a></p>
	          </div>
          </div>
        </div>
        ...
        <div class="row block-9">
          <div class="col-md-6 order-md-last d-flex">
            <form action="#" runat="server" class="bg-white p-5 contact-form">
              ...
              <div class="form-group">
				  <asp:Button ID="sendMessageBtn" class="btn btn-primary py-3 px-5" runat="server" Text="Send Message" OnClick="sendMessageBtn_Click" />
