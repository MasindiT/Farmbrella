<%@ Page Title="" Language="C#" MasterPageFile="~/FarmMaster.Master" AutoEventWireup="true" CodeBehind="shop.aspx.cs" Inherits="FarmbrellaSite.shop" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">    
    ...
    <div class="col-lg-11">
        <div class="row justify-content-end">
            ...
            <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sort By</a><span class="nav-link" id="sortID" runat="server"></span>
